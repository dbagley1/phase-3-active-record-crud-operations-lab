  ...
  describe "Create" do
    describe ".create_with_title" do
      ...
      it "creates a new record in the database" do
        expect { Movie.create_with_title("This is a title.") }.to change(
          Movie,
          :count
        ).by(1)
      end
  ...
  describe "Read" do
    ...
    describe ".find_movie_with_attributes" do
      it "returns the movie with the corresponding attributes" do
        found_movie =
          Movie.find_movie_with_attributes(title: "Movie_0", release_date: 2000)
  ...
  describe "Update" do
    describe "#update_with_attributes" do
      it "updates one movie" do
        ...
        end.to change(movie, :title).from("Awesome Flick").to(
          "Even Awesomer Flick"
        )
      end
    end
  ...
  describe "Delete" do
    ...
    describe ".delete_all_movies" do
      it "deletes all the movies from the movies table" do
        expect { Movie.delete_all_movies }.to change(Movie, :count).from(5).to(
          0
        )
      end
    end
